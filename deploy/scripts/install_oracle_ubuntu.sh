...
touch /etc/vexlo/authorized_keys
chmod 0600 /etc/vexlo/authorized_keys
chown vexlo:vexlo /etc/vexlo/authorized_keys
...
echo "3. Append trusted SSH public keys to /etc/vexlo/authorized_keys."
echo "4. Start the service with: systemctl start vexlo"
echo "5. Inspect logs with: journalctl -u vexlo -f"
